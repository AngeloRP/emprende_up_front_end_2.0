...
export class LayoutService {
  ...
  onCollapseMenu(value?){
    ...
    window.localStorage.setItem('collapse',this.store.menuCollapsed + '');
  ...
  onMinifyMenu(){
    ...
    if(window.localStorage.getItem('menuMinified') == "null" || window.localStorage.getItem('menuMinified') == "undefined" || window.localStorage.getItem('menuMinified') == undefined ){
      window.localStorage.setItem('menuMinified','1');
      $('.logInfo').hide();
    }else{
      let isMenuMinified =  parseInt(window.localStorage.getItem('menuMinified')) * -1;
      if(isMenuMinified === 1){
        $('.logInfo').hide();
      }else{
        $('.logInfo').show();
      }
      window.localStorage.setItem('menuMinified',''+isMenuMinified);
    }
